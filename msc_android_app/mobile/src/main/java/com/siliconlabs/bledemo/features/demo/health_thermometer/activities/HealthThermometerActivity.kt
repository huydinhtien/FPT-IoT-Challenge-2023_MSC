...
class HealthThermometerActivity : BaseDemoActivity() {
    ...
    private lateinit var dynamicImage: ImageView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        thermo_large_temperature.setFontFamily("sans-serif", Typeface.NORMAL)
    ...
    private fun setTemperature2(temperature: Double) {
        val rounded = round(temperature * 10) / 10
        when (rounded) {
            1.0 -> {
                dynamicImage.setImageResource(R.drawable.lying)
            }
            ...
            2.0 -> {
                dynamicImage.setImageResource(R.drawable.standing)
            }
            ...
            3.0 -> {
                dynamicImage.setImageResource(R.drawable.sitting)
            }
            ...
            4.0 -> {
                dynamicImage.setImageResource(R.drawable.jogging)
            }
    ...
    fun setTemperature1(reading: TemperatureReading?) {
        if (reading != null) {
            currentReading = reading
            temp = reading.getTemperature(currentType!!)
